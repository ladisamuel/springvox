        ...
        <div className="grid lg:grid-cols-[9fr_3fr] gap-12 lg:gap-16 items-center">
          ...
          {/* <div className="max-w-2xl flex flex-col items-center justify-center border-4"> */}
            ...
            >
              ...
              <span className="text-sm text-gray-300">Enterprise Technology Solutions</span>
            </motion.div>
            ...
            >
              SpringVox Solution Limited delivers cutting-edge AI, enterprise software, 
              cybersecurity, and digital transformation solutions that power the next 
