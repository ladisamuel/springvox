...
const features = [
  {
    ...
    description:
      "We pursue cutting-edge research and emerging technologies to build solutions that are years ahead of the curve.",
  },
  {
    icon: TrendingUp,
    title: "Scalable by Design",
    description:
      "From startups to global enterprises, our solutions scale seamlessly as your business grows and evolves.",
  },
  {
    icon: Target,
    title: "Enterprise Reliability",
    description:
      "Our platforms are architected for scale, built with 99.9% uptime standards, and trusted by organizations worldwide.",
  },
  {
    icon: Users,
    title: "Digital Transformation",
    description:
      "We don't just build software — we partner with organizations to drive complete digital evolution.",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="section-padding relative z-10 mx-auto">
        <div className="lg:max-w-[75%] border4 text-center lg:text-left">
          <motion.div
          ...
          >
            ...
            <h2 className="text-3xl lg:text-5xl font-bold mb-6 leading-tight">
              A Forward-Thinking <br className="hidden lg:block" />
          ...
          >
            <p>
              SpringVox Solution Limited is a premier technology company
              specializing in software development, enterprise solutions,
              artificial intelligence, cybersecurity, VoIP communication systems
              and digital transformation. We build our own innovative products
              while delivering world-class technology services to organizations
              across industries.
            </p>
            {/* <p>
...
"
              >
                ...
                <p className="text-sm text-gray-400 leading-relaxed">
                  To be a global leader in intelligent technology solutions,
                  setting the standard for innovation, reliability, and
          ...
          <div>
            ...
            >
              <p className="text-sm text-gray-400 leading-relaxed">
                Since 2020, we have been at the forefront of digital
                transformation, delivering innovative solutions that empower
                businesses worldwide. Our team of 100+ experts combines deep
                technical expertise with a passion for excellence.
              </p>
            </motion.div>
          </div>
        </div>
