...
const ProductSlide = ({ product, index, total }) => {
  ...
  return (
    <div className="h-full w-full bg-[#0a0f14]">
      ...
      <div className="h-full w-full flex items-center pl-24 lg:pl-40 pr-6 lg:pr-16 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto w-full">
          ...
          <div className="space-y-5 lg:space-y-6">
            <div>
              ...
              <p className={`text-sm lg:text-base font-semibold ${colors.text} mb-4`}>
                {product.subtitle}
              </p>
            ...
            <div className="flex flex-wrap gap-2">
              {product.badges.map((badge, i) => (
                <span key={i} className="px-2.5 lg:px-3 py-1 lg:py-1.5 rounded-full text-[10px] lg:text-xs font-medium bg-slate-800/80 text-slate-400 border border-slate-700/50">
                  {badge}
                </span>
              ))}
            </div>
            ...
            <div className="space-y-0.5">
              <p className="text-[10px] lg:text-xs font-bold tracking-[0.15em] text-slate-500 uppercase mb-2 lg:mb-3">Key Features</p>
            ...
            <div className="flex flex-wrap items-center gap-3 lg:gap-4 pt-1">
              <a href="#" className={`inline-flex items-center px-5 lg:px-6 py-2.5 lg:py-3 rounded-lg ${colors.btn} text-white text-xs lg:text-sm font-semibold transition-all duration-200 shadow-lg hover:shadow-xl`}>
                Request {product.name} Demo
              </a>
              <a href="#" className="inline-flex items-center text-slate-400 hover:text-white text-xs lg:text-sm font-medium transition-colors duration-200 group">
                View Documentation 
          ...
          <div className="relative">
            ...
            <div className="relative bg-[#0d1117]/60 rounded-xl border border-slate-800/60 p-4 lg:p-8 backdrop-blur-sm">
              ...
              <div className="lg:mt-36 xl:mt-32">
                <p className="text-[10px] lg:text-xs font-mono text-slate-500 mb-4 lg:mb-5 uppercase tracking-[0.15em] font-bold">Incident Timeline</p>
...
const ProductPage = () => {
  ...
  const handleScroll = useCallback(() => {
    ...
    setCarouselInView(isInView);

    if (isInView && wrapperHeight > windowHeight) {
    ...
    <div className="bg-[#0a0f14] text-white font-sans antialiased selection:bg-cyan-500/30">
      ...
      <section className="relative min-h-screen flex items-center px-4 sm:px-6 lg:px-8 xl:px-12 max-w-7xl mx-auto">
        ...
        <div className="relative max-w-4xl py-24 lg:py-32">
          <p className="text-xs font-semibold tracking-[0.2em] text-cyan-400 uppercase mb-6">— Our Products</p>
              ...
              return (
                <button
                  ...
                  onClick={() => {
                    ...
                    window.scrollTo({ top: carouselTop + 100, behavior: 'smooth' });
                  }}
      ...
      <div 
        ref={wrapperRef} 
        className="relative   border4" 
        // style={{ height: `${totalSlides * 150}vh` }}
      >
        {/* Sticky Container - max 80vh */}
        <div 
          ref={stickyRef}
          className="sticky top-[10vh] h-[80vh] w-full overflow-hidden rounded-2xl border border-slate-800/60 shadow-2xl mx-auto max-w-[95vw] xl:max-w-[90vw]"
          // className="sticky top-[10vh] h-[80vh] w-full overflow-hidden rounded-2xl border border-slate-800/60 shadow-2xl mx-auto max-w-[95vw] xl:max-w-[90vw]"
          style={{ 
        ...
        >
          {/* Progress Bar - Left Side - Full Height of carousel */}
            ...
            {products.map((product, i) => {
              ...
              return (
                <div 
                  ...
                  style={{
                    zIndex: i,
                    transform: isActive ? 'translateY(0)' : isPrev ? 'translateY(-20%)' : 'translateY(100%)',
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 xl:px-12 max-w-7xl mx-auto py-24 lg:py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {roadmapItems.map((item, i) => {
            ...
            return (
              <div key={i} className="group bg-[#0d1117] border border-slate-800/60 rounded-xl p-6 lg:p-8 hover:border-slate-700 transition-all duration-300 hover:-translate-y-1">
                <div className="flex items-center justify-between mb-4">
                  <span className={`text-[10px] font-bold tracking-[0.15em] uppercase ${colors.text}`}>{item.category}</span>
                  <span className="text-[10px] font-mono text-slate-500 bg-slate-800/60 px-2 py-1 rounded">{item.quarter}</span>
                </div>
                ...
                <a href="#" className={`inline-flex items-center text-xs font-bold ${colors.text} hover:brightness-125 transition-all group/link`}>
                  Join Waitlist 
      ...
      <section className="px-4 sm:px-6 lg:px-8 xl:px-12 max-w-7xl mx-auto pb-24 lg:pb-32">
        <div className="bg-[#0d1117] border border-slate-800/60 rounded-2xl p-8 lg:p-12 flex flex-col lg:flex-row items-center justify-between gap-8">
          <div>
            ...
            <p className="text-slate-400 text-sm lg:text-base">Talk to a SpringVox solutions expert — we'll guide you to the right fit.</p>
          </div>
