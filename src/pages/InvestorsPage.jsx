...
import {
  TrendingUp, Users, Globe, Zap, ArrowRight, Download,
  BarChart3, Shield, Target, Award, ChevronDown, Mail,
  FileText, Calendar, CheckCircle2, ArrowUpRight
} from 'lucide-react'

const metrics = [
  { label: 'Annual Recurring Revenue', value: '$12.4M', growth: '+147% YoY', icon: TrendingUp },
  { label: 'Enterprise Customers', value: '340+', growth: '+68% YoY', icon: Users },
  { label: 'Countries Deployed', value: '42', growth: 'Global Reach', icon: Globe },
  { label: 'Platform Uptime', value: '99.99%', growth: 'Enterprise SLA', icon: Zap },
]
...
const useOfFunds = [
  { category: 'R&D & Product', percent: 45, desc: 'ReKallIQ v3, PBX expansion, new AI modules' },
  { category: 'Sales & Marketing', percent: 30, desc: 'Enterprise sales team, global partnerships, brand' },
  { category: 'Infrastructure', percent: 15, desc: 'Global edge nodes, SOC 2 compliance, security' },
  { category: 'Operations', percent: 10, desc: 'Talent acquisition, legal, administrative' },
]
...
const press = [
  { source: 'TechCrunch', title: 'SpringVox Raises $24M Series A to Build the Enterprise Brain', date: 'Mar 2025' },
  { source: 'Forbes', title: 'How SpringVox Is Winning the Enterprise AI Race Without Touching Customer Data', date: 'Jan 2025' },
  { source: 'Wired', title: 'The Cloud-Native PBX That Threatens Cisco and Avaya', date: 'Nov 2024' },
  { source: 'Bloomberg', title: 'SpringVox Revenue Surges 147% as Enterprises Embrace Private AI', date: 'Sep 2024' },
]
      ...
      <div className="relative z-10">
        ...
        <section className="px-8 lg:px-16 pt-24 pb-20">
          <div className="max-w-7xl mx-auto">
            ...
            >
              <p className="text-xs font-semibold tracking-[0.2em] text-gray-500 uppercase mb-6">
                —— INVESTOR RELATIONS
              </p>
              <h1 className="text-4xl sm:text-5xl lg:text-7xl font-black tracking-tight leading-[1.1] mb-6">
                Building the{' '}
                <span className="text-cyan-400">Enterprise AI</span>{' '}
                Infrastructure of Tomorrow
              </h1>
              <p className="text-gray-400 text-lg max-w-2xl leading-relaxed mb-10">
                SpringVox is a high-growth enterprise technology company delivering
                private AI, cloud communications, and digital transformation services to
                Fortune 500 and mid-market leaders across 42 countries.
              </p>
              <div className="flex flex-wrap gap-4">
                <button className="px-8 py-4 bg-cyan-500 text-[#0c1719] rounded-lg font-bold text-sm hover:bg-cyan-400 transition-colors flex items-center gap-2">
                  <Download className="w-4 h-4" /> Download Investor Kit
                </button>
                <button className="px-8 py-4 border border-gray-700 text-white rounded-lg font-semibold text-sm hover:border-cyan-500 hover:text-cyan-400 transition-all flex items-center gap-2">
            ...
            {metrics.map((metric, i) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">{metric.label}</p>
                  <p className="text-sm text-cyan-400 font-semibold">{metric.growth}</p>
                </motion.div>
              )
            })}
          </div>
        ...
        {/* Navigation Tabs */}
        <section className="px-8 lg:px-16 pb-12 sticky top-20 z-30 bg-[#0c1719]/95 backdrop-blur-xl border-b border-gray-800/50">
          <div className="max-w-7xl mx-auto flex items-center gap-1 overflow-x-auto">
            {['overview', 'financials', 'leadership', 'strategy', 'documents'].map((tab) => (
              <button
                key={tab}
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="mb-20">
                ...
                <p className="text-gray-400 max-w-2xl mb-12">
                  ...
                  enterprise AI ($150B by 2027), cloud communications ($45B by 2028),
                  and cybersecurity services ($200B by 2027).
                </p>
                ...
                <div className="relative">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-6 relative">
                    {financialHighlights.map((item, i) => (
                      ...
                      >
                        <p className="text-xs text-cyan-400 font-bold tracking-wider uppercase mb-4">{item.year}</p>
                        <div className="space-y-3">
                          <div>
                            <p className="text-2xl font-black text-white">{item.revenue}</p>
                            <p className="text-xs text-gray-500 uppercase">Revenue</p>
                          </div>
                          <div>
                            <p className="text-lg font-bold text-white">{item.customers}</p>
                            <p className="text-xs text-gray-500 uppercase">Customers</p>
                          </div>
                          <div>
                            <p className="text-lg font-bold text-white">{item.employees}</p>
              ...
              <div className="mb-20">
                ...
                <p className="text-gray-400 max-w-2xl mb-10">
                  SpringVox is raising a $35M Series B to accelerate product development,
                  expand enterprise sales, and enter the European and APAC markets.
                </p>
                ...
                <div className="glass rounded-3xl p-8 border border-gray-800/50">
                      ...
                      <div key={item.category}>
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-3">
                            <span className="text-lg font-bold text-white">{item.percent}%</span>
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-800/50 flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-black text-white">$35,000,000</p>
                    </div>
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-xs font-bold text-cyan-400 uppercase">{item.source}</span>
            ...
            <div className="max-w-7xl mx-auto">
                  ...
                  <table className="w-full text-sm">
                    <thead>
                      <tr className="border-b border-gray-800/50">
                        <th className="text-left px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">Metric</th>
                        <th className="text-right px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">2022</th>
                        <th className="text-right px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">2023</th>
                        <th className="text-right px-6 py-4 text-xs font-bold text-gray-500 uppercase tracking-wider">2024</th>
                        <th className="text-right px-6 py-4 text-xs font-bold text-cyan-400 uppercase tracking-wider">2025E</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-800/30">
                      {[
                        ...
                        ['Services Revenue', '$0.7M', '$1.6M', '$2.6M', '$5.5M'],
                        ['Gross Margin', '62%', '68%', '74%', '78%'],
                        ['Net Revenue Retention', '105%', '112%', '118%', '125%'],
                        ...
                        <tr key={row[0]} className="hover:bg-white/[0.02] transition-colors">
                          ...
                          {row.slice(1).map((cell, j) => (
                            <td key={j} className={`px-6 py-4 text-right ${j === 3 ? 'text-cyan-400 font-semibold' : 'text-gray-400'}`}>
                              {cell}
                            </td>
                          ))}
                        </tr>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="glass rounded-2xl p-6 border border-gray-800/50">
                  <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">Run Rate ARR</p>
                  <p className="text-3xl font-black text-white mb-1">$14.2M</p>
                  <p className="text-sm text-cyan-400">+147% YoY</p>
                </div>
                <div className="glass rounded-2xl p-6 border border-gray-800/50">
                  <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">Gross Margin</p>
                  <p className="text-3xl font-black text-white mb-1">74%</p>
                  <p className="text-sm text-cyan-400">+600bps YoY</p>
                </div>
                <div className="glass rounded-2xl p-6 border border-gray-800/50">
                  <p className="text-xs text-gray-500 uppercase tracking-wider mb-2">Rule of 40</p>
                  <p className="text-3xl font-black text-white mb-1">82%</p>
                  <p className="text-sm text-cyan-400">Growth + Profitability</p>
                </div>
              </div>
            </div>
          </motion.section>
        ...
        {activeTab === 'leadership' && (
          ...
          >
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-gray-400 max-w-2xl mb-12">
                Seasoned operators from Palantir, DeepMind, Twilio, Snowflake, and
                other category-defining enterprise companies.
              </p>
                  ...
                  >
                    <div className="flex items-start gap-5">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-cyan-400 font-medium mb-3">{person.role}</p>
                        <p className="text-sm text-gray-400 leading-relaxed mb-3">{person.bio}</p>
                        <p className="text-xs text-gray-600">
                          Previously: <span className="text-gray-400">{person.previous}</span>
                        </p>
                      </div>
                    </div>
                  </motion.div>
              ...
              <div className="mt-16 glass rounded-3xl p-10 border border-gray-800/50 text-center">
                ...
                <p className="text-gray-400 max-w-lg mx-auto mb-6">
                  We are actively seeking independent directors with deep expertise in
                  enterprise SaaS, AI governance, and international expansion.
                </p>
                ...
                {[
                  {
                    ...
                    period: '2022 – 2024',
                    items: ['Launched ReKallIQ v1 and v2', 'Acquired 340+ enterprise customers', 'Achieved 99.99% platform uptime', 'Built 78-person team across 4 countries'],
                    status: 'complete',
                  },
                  {
                    phase: 'Phase 2: Scale & Expansion (Current)',
                    period: '2025 – 2026',
                    items: ['Series B funding for R&D and sales', 'Launch SpringVox PBX v2 with AI features', 'Expand to EU and APAC markets', 'Grow enterprise sales team to 50+'],
                    status: 'current',
                  },
                  {
                    phase: 'Phase 3: Platform Dominance',
                    period: '2027 – 2028',
                    items: ['Reach $100M ARR', 'IPO readiness assessment', 'Acquire complementary AI startups', 'Launch developer marketplace and APIs'],
                    status: 'future',
                  },
                ].map((phase, i) => (
                  <motion.div
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      {phase.status === 'complete' && <CheckCircle2 className="w-5 h-5 text-cyan-400" />}
                      {phase.status === 'current' && <div className="w-2 h-2 rounded-full bg-cyan-400 animate-pulse" />}
                      {phase.status === 'future' && <Target className="w-5 h-5 text-gray-600" />}
                      <h3 className="text-lg font-bold text-white">{phase.phase}</h3>
                      <span className="text-xs text-gray-500 ml-auto">{phase.period}</span>
                    </div>
                    <ul className="space-y-2 ml-8">
                      {phase.items.map((item) => (
                        <li key={item} className="text-sm text-gray-400 flex items-center gap-2">
                          <span className={`w-1 h-1 rounded-full ${phase.status === 'complete' ? 'bg-cyan-400' : phase.status === 'current' ? 'bg-cyan-400' : 'bg-gray-600'}`} />
                          {item}
                        </li>
                      ))}
                    </ul>
        ...
        {activeTab === 'documents' && (
          ...
          >
            <div className="max-w-7xl mx-auto">
              ...
              <p className="text-gray-400 max-w-2xl mb-12">
                Secure access to financial reports, cap tables, and technical documentation.
                All documents are NDA-protected.
              </p>
                ...
                {documents.map((doc, i) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <p className="text-sm font-semibold text-white group-hover:text-cyan-400 transition-colors">{doc.label}</p>
              ...
              <div className="glass rounded-3xl p-10 border border-gray-800/50 text-center">
                ...
                <h3 className="text-xl font-bold mb-2">Request a Management Presentation</h3>
                <p className="text-gray-400 max-w-lg mx-auto mb-6">
        ...
        {/* Footer CTA */}
        <section className="px-8 lg:px-16 py-20 border-t border-gray-800/50">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center">
              <button className="px-10 py-4 bg-cyan-500 text-[#0c1719] rounded-lg font-bold text-sm hover:bg-cyan-400 transition-colors">
                Request Allocation
              </button>
              <button className="px-10 py-4 border border-gray-700 text-white rounded-lg font-semibold text-sm hover:border-cyan-500 hover:text-cyan-400 transition-all">
                Speak with IR Team
              </button>
            </div>
          </div>
